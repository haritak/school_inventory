...
names = []
count=0
File.open("25_6_2015.ΚωδικοίΚτηματολογίου.txt").each do |line|
  names << line.strip #Ενα για να μείνει το τιμολόγιο
  names << line.strip #Ενα για να μπεί πάνω στο αντικείμενο
  names << line.strip #Ενα για να μπεί στην αναφορά της καταγραφής
